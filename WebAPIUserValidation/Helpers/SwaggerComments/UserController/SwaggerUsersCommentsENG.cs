namespace APIUserValidation.Helpers.SwaggerComments.UserController
{
    public static class SwaggerUsersCommentsENG
    {
        public static class Users
        {
            ...
            public const string ValidateUserSummary = "Validation of registered users";
            public const string ValidateUserDescription = @"⚡ Description: This endpoint allows the validation of users with previously registered passwords. This process can be linked to the generation of functionalities for users."
                                                           + "\n\n✅ userName (string): Username."
